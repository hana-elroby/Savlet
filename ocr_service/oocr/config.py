...
CATEGORY_TAXONOMY: dict[str, list[str]] = {
    "restaurant": [
        ...
        "ice cream", "juice", "sandwich", "chicken", "meal",
        "ايس كريم", "آيس كريم", "وجبة", "شاورما", "كباب", "أرز",
        "ساندوتش", "دجاج", "عصير", "مطعم",
    ],
    "pharmacy": [
        "medicine", "tablets", "syrup", "vitamins", "prescription", "panadol",
        "paracetamol", "capsules", "cream", "mask",
        "دواء", "حبوب", "شراب", "فيتامين", "كبسولات", "صيدلية", "صيدليه",
    ],
    "grocery": [
        "bread", "milk", "vegetables", "fruit", "cheese", "eggs", "banana",
        "supermarket", "market", "hypermarket", "water", "sugar", "oil",
        "خبز", "حليب", "خضار", "فواكه", "جبن", "بيض", "موز", "كرتون موز",
        "سوبر ماركت", "ماركت", "هايبر", "مياه", "سكر", "زيت",
    ],
    "household": [
